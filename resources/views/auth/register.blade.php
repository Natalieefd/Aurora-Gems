...
@section('content')
    ...
    <img src="{{ asset('assets/bg_about.jpg') }}" alt="" class="relative h-screen w-screen object-cover">
    <div class="absolute top-0 left-0 right-0 flex items-center justify-center h-screen bg-peach bg-opacity-30">
        <div class="p-8 rounded-lg shadow-md w-96 h-fit bg-white">
            <h1 class="text-2xl font-bold text-center mb-4">Register</h1>
            <form action="{{ route('register.action') }}" method="post" class="">
                @csrf
                @if (session('error'))
                    <div class="mb-6">
                ...
                <div class="flex justify-between mb-4">
                    <span class="text-sm">
                        ...
                        <a href="{{ route('login') }}" class="text-sm text-end text-peach hover:font-medium">
                            Login here
                        </a>
                    </span>
