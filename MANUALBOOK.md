...
<h1 class="text-4xl font-bold ">
          Detail Product Page Admin
</h1>
<img src="https://github.com/Natalieefd/Aurora-Gems/blob/main/public/ss/product_detail.png">
<h4 class="text-4xl font-normal "> 
    Halaman detail produk ini didesain dengan struktur yang terdiri dari header, konten, dan footer. Header menampilkan empat menu utama: Product, Manajemen Produk, Home, dan Logout, serta menampilkan logo Aurora Gems di bagian tengahnya. Konten halaman ini dirancang untuk menampilkan semua produk yang tersedia di website Aurora Gems, dengan setiap produk ditampilkan dalam bentuk gambar beserta nama dan harga. Admin juga dapat menggunakan tombol "Lihat Detail" untuk melihat informasi lebih lanjut tentang suatu produk. Di bagian bawah, terdapat footer yang mencakup logo Aurora Gems dan beberapa menu, seperti Help Center, FAQ, Contact Us, Terms & Conditions, dan Privacy Policy. Perlu diperhatikan bahwa pada tampilan awal halaman, menu-menu ini belum dapat diakses atau diklik. Desain ini secara keseluruhan memberikan pengguna pengalaman awal yang menarik dan informatif sebelum melakukan login atau registrasi di website Aurora Gems.
</h4>
...
<img src="https://github.com/Natalieefd/Aurora-Gems/blob/main/public/ss/create.jpeg">
<img src="https://github.com/Natalieefd/Aurora-Gems/blob/main/public/ss/add_data_product3.png">
<h4 class="text-4xl font-normal "> 
    Pada saat admin menekan tombol "Create" di halaman manajemen produk, admin akan diarahkan ke halaman tambah produk (add produk). Proses ini memungkinkan admin untuk mengisi formulir dengan informasi yang diperlukan untuk menambahkan produk baru ke dalam sistem. Halaman "add produk" berisi formulir yang mencakup kolom-kolom seperti nama, kategori, deskripsi, size, berat, warna, stok, harga, dan gambar. Admin dapat mengisi setiap kolom sesuai dengan spesifikasi produk yang akan ditambahkan. Setelah mengisi formulir, admin kemudian dapat menyimpan data dengan menekan tombol "Submit". Desain formulir ini memberikan kemudahan dan kelengkapan bagi admin dalam proses penambahan produk baru.
</h4>

<h1 class="text-4xl font-bold ">
          Manajemen Produk Admin Setelah Add Produk
</h1>
<img src="https://github.com/Natalieefd/Aurora-Gems/blob/main/public/ss/manajemen_product_add3.png">
<h4 class="text-4xl font-normal "> 
    Setelah menekan tombol "Submit" pada halaman tambah produk, admin akan diarahkan untuk kembali melihat tabel manajemen produk. Data yang baru saja diinputkan akan ditambahkan di bagian bawah tabel, sehingga admin dapat melihat secara langsung produk yang baru ditambahkan. Proses ini memastikan transisi yang lancar antara penambahan produk dan tampilan keseluruhan produk yang dikelola. Dengan demikian, admin dapat dengan cepat memverifikasi dan memastikan bahwa produk yang baru ditambahkan telah sukses terdaftar dalam database sistem dan terlihat pada halaman manajemen produk.
</h4>

<h1 class="text-4xl font-bold ">
          Edit Produk Admin 
</h1>
<img src="https://github.com/Natalieefd/Aurora-Gems/blob/main/public/ss/edit_data_product_before.png">
<img src="https://github.com/Natalieefd/Aurora-Gems/blob/main/public/ss/edit_data_product_after.png">
<h4 class="text-4xl font-normal "> 
    Pada saat admin menekan tombol "Edit" dibagian produk yang ingin diubah datanya, admin akan diarahkan ke halaman edit produk. Proses ini memungkinkan admin untuk mengubah formulir dengan informasi yang baru. Halaman "edit produk" berisi formulir yang mencakup kolom-kolom seperti nama, kategori, deskripsi, size, berat, warna, stok, harga, dan gambar. Admin dapat mengisi setiap kolom sesuai dengan spesifikasi produk yang akan diperbarui. Setelah mengisi formulir, admin kemudian dapat menyimpan data dengan menekan tombol "Submit". Desain formulir ini memberikan kemudahan dan kelengkapan bagi admin dalam proses pengeditan produk lama.
</h4>


<h1 class="text-4xl font-bold ">
          Manajemen Produk Admin Setelah Edit Produk
</h1>
<img src="https://github.com/Natalieefd/Aurora-Gems/blob/main/public/ss/manajemen_product_edit.png">
<h4 class="text-4xl font-normal "> 
    Setelah menekan tombol "Submit" pada halaman edit produk, admin akan diarahkan untuk kembali melihat tabel manajemen produk. Data yang baru saja diedit akan langsung berubah dan tetap berada pada posisi atau tata letaknya yang sebelumnya. Proses ini memastikan bahwa admin dapat dengan cepat melihat perubahan yang telah dilakukan tanpa harus mencari ulang produk yang baru diedit.
</h4>

<h1 class="text-4xl font-bold ">
          Manajemen Produk Admin Setelah Delete Produk
</h1>
<img src="https://github.com/Natalieefd/Aurora-Gems/blob/main/public/ss/manajemen_product_edit.png">
<img src="https://github.com/Natalieefd/Aurora-Gems/blob/main/public/ss/manajemen_product_add2.png">
<h4 class="text-4xl font-normal "> 
    Setelah menekan tombol "Delete" pada produk yang ingin dihapus, data akan langsung terhapus. Pada contoh ini, produk yang dihapus terdapat pada nomor 13. Awalnya, data terdiri dari 13 produk, dan setelah dilakukan penghapusan, data berubah menjadi 12 produk. Proses ini memastikan bahwa produk yang tidak diperlukan dapat dihapus dengan cepat dan hasilnya dapat segera terlihat pada tabel manajemen produk.
</h4>
