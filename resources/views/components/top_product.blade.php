<div class="container mx-auto mt-8 top-10 max-w-screen-md">
    <h2 class="text-4xl font-extrabold text-black mt-8 top-10 flex justify-center">
       NEW COLLECTION
    </h2>
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-10">
        ...
        <div class="bg-deeppink p-4 shadow-lg flex flex-col justify-center items-center  rounded-3xl">
            <img src="{{ asset('assets/producttop.jpg') }}" alt="Product 1" class="w-screen h-48  object-cover">
        ...
        <!-- Produk 2 -->
        <div class="bg-deeppink p-4 shadow-lg flex flex-col justify-center items-center rounded-3xl">
            <img src="{{ asset('assets/producttop2.jpg') }}"alt="Product 2" class="w-screen h-48 object-cover">
            <h2 class="text-xl font-semibold mt-2">Winter's Embrace</h2>
            <span class="text-2xl font-semibold text-pink-400">Rp 250.000</span>
        </div>
        <!-- Produk 3 -->
        <div class="bg-deeppink p-4 shadow-lg flex flex-col justify-center items-center rounded-3xl">
            <img src="{{ asset('assets/producttop3.jpg') }}"  alt="Product 3" class="w-screen h-48 object-cover">
